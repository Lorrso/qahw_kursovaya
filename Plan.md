...
* **CVC/CVV:** 123.
2. Нажать кнопку "Продолжить" внизу формы.
...
1. Все поля оставить пустыми. <br> 
...
2. Заполнить остальные поля формы данными: <br>
* **Месяц:** текущий месяц в формате "00".
* **Год:** текущий год.
* **Владелец:** IVAN IVANOV.
* **CVC/CVV:** 123.
...
* **CVC/CVV:** 123.
3. Нажать кнопку "Продолжить" внизу формы. <br>
**Ожидаемый результат:** Данные формы отправляются симулятору банковского сервиса, но операция по покупке тура не может быть выполнена, так как переданной карты не существует. Пользователь видит в правом верхнем углу уведомление: "Ошибка! Банк отказал в проведении операции".

#### Сценарий 5. Отправка формы покупки с предыдущим месяцем в поле "Месяц".
...
#### Сценарий 6. Отправка формы покупки с одной цифрой в поле "Месяц".
...
#### Сценарий 7. Отправка формы покупки с недопустимым нижним граничным значением в поле "Месяц".
...
#### Сценарий 8. Отправка формы покупки с недопустимым верхним граничным значением в поле "Месяц".
...
#### Сценарий 9. Отправка формы покупки с предыдущим годом в поле "Год".
...
#### Сценарий 10. Отправка формы покупки с годом, следующим через 6 лет от нынешнего, в поле "Год".
...
#### Сценарий 11. Отправка формы покупки с одной цифрой в поле "Год".
...
#### Сценарий 12. Отправка формы покупки с неполными данными в поле "Владелец".
...
**Ожидаемый результат:** Поле "Владелец" выделяется красным цветом. Под ним появляется надпись: "Неверный формат". Операция по отправке формы не происходит.
  ...
  #### Сценарий 13. Отправка формы покупки со спецсимволами в поле "Владелец".
...
#### Сценарий 14. Отправка формы покупки с иероглифами в поле "Владелец".
...
#### Сценарий 15. Отправка формы покупки с двумя цифрами в поле "CVC/CVV".
